...
- [ ] Confirm Pressure Index's field-level schema (time granularity, location scoping) — unverified; only relevant if pursuing tactical correlation beyond the ball-position heat map/trail already decided (§2/§5), not a blocker for anything currently in scope
